...
export const TERMINAL_FAILURE_SEMANTICS = {
  ...
  agent_policy_refused: { category: "policy", outcome: "inconclusive" },
  agent_blocked: { category: "ambiguity", outcome: "inconclusive" },
  agent_needs_input: { category: "ambiguity", outcome: "inconclusive" },
